...
elseif string.upper(algorithm) == "GREEDY_BFS" then
    findPath = require("greedyBFS").greedy_bfs
elseif string.upper(algorithm) == "DIJKSTRA" then
    findPath = require("Dijkstra").dijkstra
else
